import { deployUSDO, deployStakedUSDO, deployStakingRewardsDistributor } from "../functions";
...
async function main() {
	try {
		await deployUSDO();
		await deployStakedUSDO('0x72872f101327902fC805637Cccd9A3542ed31e47');
		...
		console.error("USDO deployment failed ->", err);
	}
}
