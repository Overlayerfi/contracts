...
export async function ethBalance(addr: string, target: string, rpc: string, decimals: number): Promise<string> {
...
ethBalance(USDT_ADDRESS, "0x10fc45741bfE5D527c1b83Fe0BD70fC96D7ec30F", "http://127.0.0.1:8545/", 6).catch((error) => {
	console.error(error);
}).then((res) => {
